...
const SYSTEM = [
  ...
  '— ОБЯЗАТЕЛЬНОЕ ПОЛЕ РОВНО ОДНО: имя контакта (для заявки — clientId). Больше ничего не обязательно.',
  '  Всё остальное — бюджет, район, спальни, канал, цель — НЕОБЯЗАТЕЛЬНО. Нет их — заводи без них.',
  '— Спрашивай ТОЛЬКО то, без чего операция не пройдёт. Это всегда одно поле, и почти всегда — имя.',
