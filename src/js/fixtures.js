...
(function (WS) {
  ...
  const clients = [
    ...
    { id: 'c_lead15', name: 'Дмитрий Соколов', tag: 's15', lang: 'RU', channel: 'telegram', consent: true, ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_ambig', name: 'Елена Крылова', tag: 'g3', lang: 'RU', channel: 'call', consent: true, ctype: 'owner',
