...
(function (WS) {
  ...
  const clients = [
    {
      id: 'c_anna', name: 'Анна Петрова', residency: 'resident', visaGoal: false, payment: 'cash', nameDat: 'Анне Петровой', nameGen: 'Анны Петровой', tag: 'main', lang: 'RU', channel: 'whatsapp',
      // Тип клиента — правило движка поводов («инвестор покупает раз в год»), а не ярлык.
      ctype: 'investor', birthday: '18 мая',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
      consent: true, consentAt: '18 марта 2026', consentUntil: '18 марта 2027', goal: 'Инвестиционная квартира', budget: 2000000,
      areas: ['Business Bay', 'Dubai Creek Harbour', 'JVC'], horizon: '1–3 месяца',
      /* Пожелания — не фильтр. Анна возьмёт вариант и без воды, но узнать об этом
         должна от брокера, а не на показе. */
      wants: ['sea', 'metro'],
    ...
    { id: 'c_lead15', name: 'Дмитрий Соколов', residency: 'non-resident', visaGoal: true, payment: 'mortgage', nameDat: 'Дмитрию Соколову', nameGen: 'Дмитрия Соколова', tag: 's15', lang: 'RU', channel: 'telegram', consent: true, consentAt: '28 мая 2025', consentUntil: '28 мая 2026', ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_night', name: 'Sarah Mansour', residency: 'non-resident', visaGoal: false, payment: 'cash', nameDat: 'Sarah Mansour', nameGen: 'Sarah Mansour', tag: 's14', lang: 'EN', channel: 'whatsapp', consent: true, consentAt: '14 мая 2026', consentUntil: '14 мая 2027', ctype: 'investor',
      contactKind: 'buyer', interest: 'rent', objTypes: ['apart'],
    ...
    { id: 'c_overdue', name: 'Игорь Лебедев', residency: 'resident', visaGoal: false, payment: 'cash', nameDat: 'Игорю Лебедеву', nameGen: 'Игоря Лебедева', tag: 's5', lang: 'RU', channel: 'whatsapp', consent: true, consentAt: '02 мая 2026', consentUntil: '02 мая 2027', ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
      goal: 'Апартаменты под перепродажу', budget: 2400000, areas: ['Business Bay'], horizon: '1–2 месяца',
      note: 'Просрочен контакт (обещали КП 12 мая).', phone: '+971 55 •••• ••02 (DEMO)',
      psych: { filled: true, decision: 'Статусный — важны престиж и «первым узнать»', values: ['Статус/престиж', 'Скорость'],
        ...
        source: 'выведено из истории общения (сигналы стиля)' } },
    { id: 'c_noconsent', name: 'Марат Ибрагимов', residency: 'non-resident', visaGoal: true, payment: 'mortgage', nameDat: 'Марату Ибрагимову', nameGen: 'Марата Ибрагимова', tag: 's13', lang: 'RU', channel: 'whatsapp', consent: false, ctype: 'enduser',
    ...
    { id: 'c_ambig', name: 'Елена Крылова', residency: 'resident', visaGoal: false, payment: 'cash', nameDat: 'Елене Крыловой', nameGen: 'Елены Крыловой', tag: 'g3', lang: 'RU', channel: 'call', consent: true, consentAt: '21 февраля 2026', consentUntil: '21 февраля 2027', ctype: 'owner',
      contactKind: 'owner', interest: 'office', objTypes: ['office'],
    ...
    { id: 'c_docs', name: 'Виктор Орлов', residency: 'non-resident', visaGoal: true, payment: 'mortgage', nameDat: 'Виктору Орлову', nameGen: 'Виктора Орлова', tag: 's4', lang: 'RU', channel: 'email', consent: true, consentAt: '06 апреля 2026', consentUntil: '06 апреля 2027', ctype: 'enduser',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_owner', name: 'Сергей Орлов', residency: 'resident', visaGoal: false, payment: 'cash', nameDat: 'Сергею Орлову', nameGen: 'Сергея Орлова', tag: 'own', lang: 'RU', channel: 'email', consent: true, consentAt: '09 мая 2026', consentUntil: '09 мая 2027', ctype: 'owner',
      ...
      goal: 'Реализовать офисный блок в DIFC', budget: 12000000, /* Palm Jumeirah добавлен нарочно: объектов у нас там нет ни одного,
        ...
        areas: ['DIFC', 'JBR'], horizon: '3–6 месяцев',
  ...
  const objects = [
    { id: 'o_creekline', name: 'Creekline Residences, Unit 1208', source: 'agency',
      ...
      deal: 'sale', segment: 'off-plan', developer: 'Emaar Properties', project: 'Creekline Residences · Tower B',
    ...
    { id: 'o_palmcourt', name: 'Palm Court Residence, Unit 704', source: 'club',
      ...
      deal: 'sale', segment: 'resale', developer: 'Nakheel', project: 'Palm Court Residence · District 12',
    ...
    { id: 'o_downtown2br', name: 'Boulevard Heights, Unit 2104', source: 'agency',
      ...
      deal: 'sale', segment: 'resale', developer: 'Emaar Properties', project: 'Boulevard Heights · Downtown',
    ...
    { id: 'o_marinasea', name: 'Marina Vista, Unit 1806', source: 'club',
      ...
      deal: 'sale', segment: 'resale', developer: 'Emaar Properties', project: 'Marina Vista · Dubai Marina',
    ...
    { id: 'o_jvc2br', name: 'Bloom Gardens, Unit 512', source: 'agency',
      ...
      deal: 'sale', segment: 'resale', developer: 'Nakheel', project: 'Bloom Gardens · JVC',
    ...
    { id: 'o_bayline', name: 'Bayline Terraces, Unit 1603', source: 'import',
      ...
      deal: 'sale', segment: 'off-plan', developer: 'Emaar Properties', project: 'Bayline Terraces · Dubai Creek Harbour',
    ...
    { id: 'o_difc_a', name: 'DIFC Gate District, Office 1204', source: 'club',
      ...
      deal: 'sale', segment: 'resale', developer: 'DIFC Authority', project: 'DIFC Gate District',
    ...
    { id: 'o_baycentral', name: 'Bay Central Tower, Unit 1907', source: 'agency',
      ...
      deal: 'sale', segment: 'off-plan', developer: 'Emaar Properties', project: 'Bay Central Tower',
    ...
    { id: 'o_bbloft', name: 'Bay Loft Residences, Unit 1105', source: 'agency',
      ...
      deal: 'rent', segment: 'resale', rentYear: 71000, developer: 'Meydan Group', project: 'Bay Loft Residences',
    ...
    { id: 'o_jvcstudio', name: 'Bloom Heights JVC, Unit 412', source: 'agency',
      ...
      deal: 'sale', segment: 'resale', developer: 'Bloom Holding', project: 'Bloom Heights',
    ...
    { id: 'o_creek2', name: 'Creek Rise, Unit 2703', source: 'import',
      ...
      deal: 'sale', segment: 'resale', developer: 'Emaar Properties', project: 'Creek Rise',
    ...
    { id: 'o_bboffice', name: 'Prime Tower Office, Unit 906', source: 'agency',
      ...
      deal: 'sale', segment: 'resale', developer: 'Meydan Group', project: 'Prime Tower',
    ...
    { id: 'o_difcblock', name: 'DIFC Gate Avenue, Block 3', source: 'club',
      ...
      deal: 'sale', segment: 'resale', developer: 'DIFC Authority', project: 'DIFC Gate Avenue',
    ...
    { id: 'o_jvcpark', name: 'Park Terrace JVC, Unit 903', source: 'agency',
      ...
      deal: 'sale', segment: 'resale', developer: 'Nakheel', project: 'Park Terrace · District 14',
      handover: null, paymentPlan: null, serviceCharge: '13 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
    ...
    /* Дальше — лоты, добавленные по дырам из разбора 29 диалогов с брокером.
       Цена каждого выведена из индекса района, а не выдумана: иначе экран района
       и карточка объекта говорят разное об одном и том же метре. */

    { id: 'o_palm2br', name: 'Palm Tower Residences, Unit 4102', source: 'club',
      sourceLabel: 'Клубный эксклюзив', area: 'Palm Jumeirah', price: 6600000, size: 140, br: '2BR',
      address: 'Palm Jumeirah, Palm Tower, Unit 4102', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '10 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 271 411 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04243 (DEMO)',
      attrs: { view: 'sea', floor: 41, floors: 52, floorBand: 'high', finish: 'new', demand: 'mid', prestige: 'high', metro: false },
      match: 'Адрес Пальмы, море из окна, две спальни.',
      deal: 'sale', segment: 'resale', developer: 'Nakheel', project: 'Palm Tower · Palm Jumeirah',
      handover: null, paymentPlan: null, serviceCharge: '30 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
      usp: 'Этаж выше смотровой площадки: вид на море и на линию Марины одновременно, и его не перекроет никто — выше строить на стволе Пальмы негде.' },

    { id: 'o_palmrent', name: 'Shoreline Apartments, Unit 806', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'Palm Jumeirah', price: 5750000, size: 130, br: '2BR',
      address: 'Palm Jumeirah, Shoreline Apartments, Unit 806', commissionPct: 5,
      availability: 'available', verified: 'verified', checkedAt: '9 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 278 412 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04256 (DEMO)',
      attrs: { view: 'sea', floor: 8, floors: 10, floorBand: 'high', finish: 'standard', demand: 'high', prestige: 'high', metro: false },
      match: 'Аренда на Пальме с выходом на пляж.',
      deal: 'rent', segment: 'resale', rentYear: 265000, developer: 'Nakheel', project: 'Shoreline · Palm Jumeirah',
      handover: null, paymentPlan: null, serviceCharge: '28 AED/фт²·год', escrow: null,
      occupancy: 'Свободна с октября',
      usp: 'Корпус с прямым выходом на пляж, а не через дорогу: в Shoreline таких три из одиннадцати, и ставка у них держится выше в любой сезон.' },

    { id: 'o_jlt1br', name: 'Lake Terrace, Unit 1904', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'JLT', price: 1390000, size: 76, br: '1BR',
      address: 'Jumeirah Lake Towers, Lake Terrace, Unit 1904', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '11 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 285 413 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04269 (DEMO)',
      attrs: { view: 'water', floor: 19, floors: 40, floorBand: 'high', finish: 'standard', demand: 'high', prestige: 'mid', metro: true },
      match: 'Самая высокая доходность из наших районов, метро рядом.',
      deal: 'sale', segment: 'resale', developer: 'DMCC', project: 'Lake Terrace · JLT Cluster D',
      handover: null, paymentPlan: null, serviceCharge: '16 AED/фт²·год', escrow: null,
      occupancy: 'Сдана до апреля 2027',
      usp: 'Окна на озеро, а не во внутренний двор кластера, и до станции метро семь минут пешком по тени — в JLT это редкость для лета.' },

    { id: 'o_jltoffice', name: 'Almas Tower, Office 3705', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'JLT', price: 1890000, size: 96, br: 'Офис',
      address: 'Jumeirah Lake Towers, Almas Tower, Office 3705', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '8 сент 2026',
      trakheesi: 'pending', madmoun: 'na',
      attrs: { view: 'city', floor: 37, floors: 68, floorBand: 'high', finish: 'standard', demand: 'mid', prestige: 'mid', metro: true },
      match: 'Офис во фризоне DMCC с лицензией на месте.',
      deal: 'sale', segment: 'resale', developer: 'DMCC', project: 'Almas Tower · JLT',
      handover: null, paymentPlan: null, serviceCharge: '19 AED/фт²·год', escrow: null,
      occupancy: 'Свободен (fitted)',
      usp: 'Офис с готовой отделкой в башне самой фризоны: лицензию и визы оформляют в том же здании, на два этажа ниже.' },

    { id: 'o_arjanstudio', name: 'Vincitore Boulevard, Unit 312', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'Arjan', price: 560000, size: 46, br: 'Студия',
      address: 'Arjan, Vincitore Boulevard, Unit 312', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '11 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 292 414 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04282 (DEMO)',
      attrs: { view: 'city', floor: 3, floors: 12, floorBand: 'low', finish: 'new', demand: 'high', prestige: 'low', metro: false },
      match: 'Самый дешёвый вход в инвентаре, доходность выше восьми процентов.',
      deal: 'sale', segment: 'resale', developer: 'Vincitore Realty', project: 'Vincitore Boulevard · Arjan',
      handover: null, paymentPlan: null, serviceCharge: '12 AED/фт²·год', escrow: null,
      occupancy: 'Сдана до февраля 2027',
      usp: 'Студия с отдельной кухней, а не с нишей в комнате: арендаторы в этом бюджете выбирают именно по этому признаку.' },

    { id: 'o_arjan1br', name: 'Samana Golf Views, Unit 704', source: 'import',
      sourceLabel: 'Импорт застройщика', area: 'Arjan', price: 790000, size: 68, br: '1BR',
      address: 'Arjan, Samana Golf Views, Unit 704', commissionPct: 4,
      availability: 'available', verified: 'verified', checkedAt: '12 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 299 415 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04295 (DEMO)',
      attrs: { view: 'garden', floor: 7, floors: 18, floorBand: 'mid', finish: 'new', demand: 'high', prestige: 'low', metro: false },
      match: 'Оффплан под аренду с рассрочкой от застройщика.',
      deal: 'sale', segment: 'off-plan', developer: 'Samana Developers', project: 'Samana Golf Views · Arjan',
      handover: 'Q3 2027', paymentPlan: '20% бронь · 40% в стройку · 40% на сдаче',
      serviceCharge: '12 AED/фт²·год', escrow: 'Эскроу-счёт проекта в Mashreq, надзор RERA',
      occupancy: null,
      usp: 'У юнита свой бассейн на балконе — у этого застройщика это фирменный признак, и на пересдаче он добавляет к ставке около десяти процентов.' },

    { id: 'o_beachfront2br', name: 'Beach Vista, Unit 2103', source: 'club',
      sourceLabel: 'Клубный эксклюзив', area: 'Emaar Beachfront', price: 4480000, size: 118, br: '2BR',
      address: 'Emaar Beachfront, Beach Vista, Unit 2103', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '12 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 306 416 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04308 (DEMO)',
      attrs: { view: 'sea', floor: 21, floors: 33, floorBand: 'high', finish: 'new', demand: 'high', prestige: 'high', metro: false },
      match: 'Море из окна, две спальни, готово к въезду.',
      deal: 'sale', segment: 'resale', developer: 'Emaar Properties', project: 'Beach Vista · Emaar Beachfront',
      handover: null, paymentPlan: null, serviceCharge: '24 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
      usp: 'Фронтальный вид на море без соседней башни в створе окна: в Beach Vista таких линий две, остальные смотрят на гавань.' },

    { id: 'o_beachfrontoff', name: 'Palace Beach Residence, Unit 1806', source: 'import',
      sourceLabel: 'Импорт застройщика', area: 'Emaar Beachfront', price: 4000000, size: 111, br: '2BR',
      address: 'Emaar Beachfront, Palace Beach Residence, Unit 1806', commissionPct: 2.5,
      availability: 'available', verified: 'verified', checkedAt: '12 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 313 417 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04321 (DEMO)',
      attrs: { view: 'sea', floor: 18, floors: 42, floorBand: 'high', finish: 'new', demand: 'high', prestige: 'high', metro: false },
      match: '111 м² с видом на море, рассрочка от Emaar.',
      deal: 'sale', segment: 'off-plan', developer: 'Emaar Properties', project: 'Palace Beach Residence · Emaar Beachfront',
      handover: 'Q4 2027', paymentPlan: '10% бронь · 40% в стройку · 50% на сдаче',
      serviceCharge: '24 AED/фт²·год', escrow: 'Эскроу-счёт проекта в ADCB, надзор RERA',
      occupancy: null,
      usp: 'Корпус стоит первым от воды, и пляж у него свой, а не общий на квартал — у Emaar это записано в плане застройки.' },

    { id: 'o_downtown1br', name: 'Burj Views, Unit 1207', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'Downtown Dubai', price: 2210000, size: 74, br: '1BR',
      address: 'Downtown Dubai, Burj Views, Unit 1207', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '10 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 320 418 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04334 (DEMO)',
      attrs: { view: 'city', floor: 12, floors: 26, floorBand: 'mid', finish: 'standard', demand: 'mid', prestige: 'high', metro: true },
      match: 'Адрес Downtown по нижней границе района.',
      deal: 'sale', segment: 'resale', developer: 'Emaar Properties', project: 'Burj Views · Downtown',
      handover: null, paymentPlan: null, serviceCharge: '22 AED/фт²·год', escrow: null,
      occupancy: 'Сдана до мая 2027',
      usp: 'Самый дешёвый вход в Downtown из того, что стоит сейчас: до торгового центра десять минут пешком, но окна не на башню — оттого и цена.' },

    { id: 'o_marina1br', name: 'Marina Gate 2, Unit 3308', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'Dubai Marina', price: 1980000, size: 78, br: '1BR',
      address: 'Dubai Marina, Marina Gate 2, Unit 3308', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '11 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 327 419 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04347 (DEMO)',
      attrs: { view: 'water', floor: 33, floors: 55, floorBand: 'high', finish: 'new', demand: 'high', prestige: 'high', metro: true },
      match: 'Марина, высокий этаж, одна спальня.',
      deal: 'sale', segment: 'resale', developer: 'Select Group', project: 'Marina Gate · Dubai Marina',
      handover: null, paymentPlan: null, serviceCharge: '20 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
      usp: 'Окна на гавань, а не на шоссе: в Marina Gate эта линия дороже соседней на семь процентов и сдаётся за неделю.' },

    { id: 'o_creek3', name: 'Creek Edge, Unit 1802', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'Dubai Creek Harbour', price: 2390000, size: 106, br: '2BR',
      address: 'Dubai Creek Harbour, Creek Edge, Unit 1802', commissionPct: 2,
      availability: 'available', verified: 'verified', checkedAt: '9 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 334 420 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04360 (DEMO)',
      attrs: { view: 'canal', floor: 18, floors: 40, floorBand: 'high', finish: 'new', demand: 'mid', prestige: 'mid', metro: false },
      match: 'Две спальни в Creek Harbour, вид на лагуну.',
      deal: 'sale', segment: 'resale', developer: 'Emaar Properties', project: 'Creek Edge · Dubai Creek Harbour',
      handover: null, paymentPlan: null, serviceCharge: '18 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
      usp: 'Две спальни с разных сторон гостиной — планировка под две семьи или под сдачу по комнатам, что в Creek Harbour разрешено далеко не везде.' },

    { id: 'o_jvcrent', name: 'Belgravia Heights, Unit 405', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'JVC', price: 1120000, size: 62, br: '1BR',
      address: 'Jumeirah Village Circle, Belgravia Heights, Unit 405', commissionPct: 5,
      availability: 'available', verified: 'verified', checkedAt: '12 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 341 421 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04373 (DEMO)',
      attrs: { view: 'park', floor: 4, floors: 14, floorBand: 'low', finish: 'new', demand: 'high', prestige: 'mid', metro: false },
      match: 'Аренда односпальной в JVC, свободна сейчас.',
      deal: 'rent', segment: 'resale', rentYear: 62000, developer: 'Ellington Properties', project: 'Belgravia Heights · JVC',
      handover: null, paymentPlan: null, serviceCharge: '14 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
      usp: 'Сдаётся с мебелью и техникой, и собственник готов на четыре чека в год — в JVC чаще просят один.' },

    { id: 'o_bbrent2br', name: 'Executive Towers, Unit 2210', source: 'agency',
      sourceLabel: 'Инвентарь агентства', area: 'Business Bay', price: 2140000, size: 101, br: '2BR',
      address: 'Business Bay, Executive Towers, Unit 2210', commissionPct: 5,
      availability: 'available', verified: 'verified', checkedAt: '11 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 348 422 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04386 (DEMO)',
      attrs: { view: 'canal', floor: 22, floors: 36, floorBand: 'high', finish: 'standard', demand: 'high', prestige: 'mid', metro: true },
      match: 'Аренда двуспальной у канала, метро рядом.',
      deal: 'rent', segment: 'resale', rentYear: 109000, developer: 'DAMAC', project: 'Executive Towers · Business Bay',
      handover: null, paymentPlan: null, serviceCharge: '17 AED/фт²·год', escrow: null,
      occupancy: 'Свободна с ноября',
      usp: 'Башня с выходом на набережную и собственным торговым этажом: семьи с детьми выбирают её из-за этого и живут по нескольку лет.' },

    { id: 'o_marinarent', name: 'Sparkle Towers, Unit 1504', source: 'partner',
      sourceLabel: 'Партнёрский лот', area: 'Dubai Marina', price: 2540000, size: 98, br: '2BR',
      address: 'Dubai Marina, Sparkle Towers, Unit 1504', commissionPct: 5,
      availability: 'available', verified: 'verified', checkedAt: '8 сент 2026',
      trakheesi: 'ok', trakheesiNo: '71 355 423 (DEMO)', madmoun: 'ok', madmounNo: 'MD-04399 (DEMO)',
      attrs: { view: 'water', floor: 15, floors: 30, floorBand: 'mid', finish: 'new', demand: 'high', prestige: 'high', metro: true },
      match: 'Аренда двуспальной в Марине от партнёра.',
      deal: 'rent', segment: 'resale', rentYear: 155000, developer: 'Tebyan', project: 'Sparkle Towers · Dubai Marina',
      handover: null, paymentPlan: null, serviceCharge: '21 AED/фт²·год', escrow: null,
      occupancy: 'Свободна (vacant)',
      usp: 'Квартира с отделкой от застройщика и мебелью Swarovski в общих зонах — аргумент для арендатора, который выбирает между двумя одинаковыми башнями.' },
  ];
  ...
  const AREAS = {
    ...
    /* Три района стояли в срезе рынка своими числами, мимо этого справочника,
       и без единого лота в них. Стенд называл цену метра там, где ему нечего
       предложить. Теперь они здесь, и срез проецируется из одного места. */
    'JLT': {
      perM2: 17900, priceYoY: 9, rentYoY: 7, yieldTypical: 7.1, dom: 39,
      tenant: 'Сотрудники компаний свободной зоны DMCC — живут там же, где работают, и продлевают договор годами.',
      driver: 'Самая высокая доходность из наших районов при метро у двери и соседстве с Мариной через дорогу.',
      risk: 'Башни очень разные по управлению: сервисный сбор в соседних домах отличается вдвое — смотреть по конкретной башне.',
    },
    'Palm Jumeirah': {
      perM2: 48200, priceYoY: 5, rentYoY: 4, yieldTypical: 4.6, dom: 74,
      tenant: 'Состоятельные семьи на долгий срок и курортная посуточная аренда в сезон.',
      driver: 'Адрес и собственный пляж — то, чего нельзя повторить новостройкой в другом месте.',
      risk: 'Самая дорогая цена метра и самый высокий сервисный сбор в городе, метро нет, продаётся долго.',
    },
    'Arjan': {
      perM2: 11600, priceYoY: 13, rentYoY: 10, yieldTypical: 8.1, dom: 31,
      tenant: 'Молодые специалисты и семьи с ограниченным бюджетом, часто первая аренда в Дубае.',
      driver: 'Самый дешёвый вход и самая высокая доходность: берут ради аренды, а не ради адреса.',
      risk: 'Очередь новостроек велика — новое предложение давит на ставку; метро нет, нужна машина.',
    },
    'Emaar Beachfront': {
      perM2: 38000, priceYoY: 8, rentYoY: 7, yieldTypical: 5.2, dom: 52,
      tenant: 'Арендаторы ради моря и посуточная аренда: собственный пляж закрыт для посторонних.',
      driver: 'Море из окна плюс управление Emaar — сочетание, которого в Марине уже не купить.',
      risk: 'Район ещё достраивается: вторички мало, часть соседних башен в стройке до 2028 года.',
    },
    'Dubai Creek Harbour': {
  ...
  const requests = [
    ...
    { id: 'r_igor', clientId: 'c_overdue', title: 'Перепродажа в Dubai Creek Harbour', createdAt: '10 мая', channel: 'whatsapp',
      ...
      note: 'Обсуждали перепродажу в Bayline Terraces. КП обещали 12 мая и не отправили — контакт просрочен.' },
    ...
    { id: 'r_viktor_rent', clientId: 'c_docs', title: 'Аренда офиса в DIFC на год', createdAt: '12 мая',
      ...
      /* Единственное КП без объектов на физической услуге, и это законное исключение, а не
         разрыв: предметом здесь стали УСЛОВИЯ аренды (годовой чек, ставка), а не юнит.
         Своих офисов под аренду в DIFC нет ни одного — 1204 и 1206 держит портфельная
         сделка и оба сданы до 2027 года, блок на Gate Avenue занят арендаторами. Пустоту
         подтверждает и лента заявки: КП ушло письмом 13 мая. Поэтому исключение объявлено
         явно, а не выведено проверкой из молчания. */
      kp: { formed: true, at: '13 мая', objectIds: [],
        emptyReason: 'КП на условия аренды: свободных офисов в DIFC в инвентаре нет, подбор идёт через партнёров' },
  ...
  // `at` — дата, на которую расхождение записано. Без неё карточка расхождения на сделке,
  // выросшей из заявки, читалась бы как сегодняшний факт, а не как незакрытая история.
  const conflicts = {
    r_karim: { field: 'Бюджет', a: '≈ 2,0 млн (первое сообщение)', b: 'до 2,6 млн (уточнение)', av: 2000000, bv: 2600000, chosen: 'b', at: '14 мая', note: 'Взято последнее уточнение; исходное значение сохранено.' },
  };
  ...
  /* ---------- Сборы и пороги сделки ----------

     Сначала эти числа лежали текстом в инструкции модели — на сервере, вне контроля
     версий, без источника и без даты. Подтвердить такое нельзя, увидеть устаревшее тоже:
     тариф меняется, а стенд продолжает называть старое число уверенным голосом.

     Здесь они живут по тому же правилу, что срез рынка: у каждого числа есть `basis`
     (откуда оно взято), `source` (где опубликовано) и `asOf` (на какую дату). Консьерж
     обязан проговаривать происхождение вслух, и брокеру есть чем ответить клиенту.

     Три рода происхождения, и они НЕ равноценны:
       official   — официальный тариф, опубликован ведомством;
       industry   — отраслевая публикация, МЫ ЭТО НЕ ПОДТВЕРЖДАЛИ;
       per_deal   — величина своя у каждого застройщика и договора, уточняется по сделке.

     То, что помечено industry и per_deal, нельзя подавать как проверенный факт. Это не
     перестраховка: первая же версия инструкции записала покупателю первички агентскую
     комиссию, которую он не платит вовсе, — и смета входа была завышена на 36 400 AED. */
  const TARIFF_CHECKED = '7 сентября 2026';
  const TARIFFS = [
    { id: 't_dld', название: 'Передача права в Земельный департамент',
      величина: '4% от цены', процент: 4, кто_платит: 'покупатель',
      когда: 'при регистрации сделки',
      basis: 'official', source: 'Dubai Land Department', asOf: TARIFF_CHECKED },

    { id: 't_dld_admin', название: 'Административный сбор регистрации',
      величина: '4 000 AED + 5% НДС', сумма: 4200, кто_платит: 'покупатель',
      когда: 'при регистрации, для объектов дороже 500 000',
      basis: 'official', source: 'Dubai Land Department', asOf: TARIFF_CHECKED },

    { id: 't_oqood', название: 'Регистрация Oqood (договор по строящемуся)',
      величина: 'около 1 000 AED', сумма: 1000, кто_платит: 'покупатель',
      когда: 'только off-plan, при внесении в реестр',
      basis: 'industry', source: 'отраслевые публикации', asOf: TARIFF_CHECKED,
      оговорка: 'точную величину называет застройщик при бронировании' },

    { id: 't_agency_primary', название: 'Агентское вознаграждение на первичке',
      величина: '0 для покупателя', сумма: 0, кто_платит: 'застройщик',
      когда: 'покупка напрямую у застройщика (off-plan, первичка)',
      basis: 'industry', source: 'практика рынка Дубая', asOf: TARIFF_CHECKED },

    { id: 't_agency_resale', название: 'Агентское вознаграждение на вторичке',
      величина: '2% + НДС', процент: 2, кто_платит: 'покупатель',
      когда: 'вторичка и переуступка',
      basis: 'industry', source: 'практика рынка Дубая', asOf: TARIFF_CHECKED },

    { id: 't_noc', название: 'Разрешение застройщика на переуступку (NOC)',
      величина: 'порядка 1 000–2 000 AED', кто_платит: 'продавец',
      когда: 'переуступка до сдачи',
      basis: 'per_deal', source: 'у застройщика по конкретной сделке', asOf: TARIFF_CHECKED,
      оговорка: 'у каждого застройщика своя; уточняется у менеджера проекта' },

    { id: 't_assignment', название: 'Сбор застройщика за переоформление',
      величина: 'по отраслевым данным 2–4% от первоначальной цены',
      кто_платит: 'продавец', когда: 'переуступка до сдачи',
      basis: 'per_deal', source: 'у застройщика по конкретной сделке', asOf: TARIFF_CHECKED,
      оговорка: 'решающая величина в экономике выхода — без неё совет «выйти до сдачи» не считается' },

    { id: 't_assign_threshold', название: 'Порог для переуступки',
      величина: 'по отраслевым данным около 40% ФАКТИЧЕСКИ оплаченных',
      когда: 'переуступка до сдачи',
      basis: 'per_deal', source: 'договор с застройщиком (SPA)', asOf: TARIFF_CHECKED,
      оговорка: 'считается по ОПЛАЧЕННОМУ, а не по плану; в договоре бывает отдельный запрет на первые 12–24 месяца' },

    { id: 't_golden_visa', название: 'Порог золотой визы',
      величина: '2 000 000 AED', сумма: 2000000, когда: 'резиденция на 10 лет',
      basis: 'industry', source: 'отраслевые публикации', asOf: TARIFF_CHECKED,
      оговорка: 'по off-plan право возникает с регистрации Oqood; объекты складываются до порога в одном имени' },
  ];
  ...
  const market = [
    ...
    fromArea('jlt', 'JLT', { offplan: 12 }),
    fromArea('palm', 'Palm Jumeirah', { offplan: 15 }),
    fromArea('arjan', 'Arjan', { offplan: 55 }),
    fromArea('beachfront', 'Emaar Beachfront', { offplan: 44 }),
    /* Единственный район в срезе БЕЗ наших лотов — и это намеренно.
       Знать цену там, где ничего не держишь, — норма для агентства, и именно там
       живёт co-broking: партнёр даёт лот, мы — покупателя. Наполнив было все
       районы подряд, стенд потерял бы целый разбор Пульса. */
    district('jbr', 'JBR', 27800, 5.8, { yoy: 6, dom: 48, offplan: 4 }),
  ];
