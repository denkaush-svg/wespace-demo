...
(function (WS) {
  ...
  const clients = [
    ...
    { id: 'c_lead15', name: 'Дмитрий Соколов', tag: 's15', lang: 'RU', channel: 'telegram', consent: true, consentAt: '28 мая 2025', consentUntil: '28 мая 2026', ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_night', name: 'Sarah Mansour', tag: 's14', lang: 'EN', channel: 'whatsapp', consent: true, consentAt: '14 мая 2026', consentUntil: '14 мая 2027', ctype: 'investor',
    ...
    { id: 'c_overdue', name: 'Игорь Лебедев', tag: 's5', lang: 'RU', channel: 'whatsapp', consent: true, consentAt: '02 мая 2026', consentUntil: '02 мая 2027', ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_ambig', name: 'Елена Крылова', tag: 'g3', lang: 'RU', channel: 'call', consent: true, consentAt: '21 февраля 2026', consentUntil: '21 февраля 2027', ctype: 'owner',
    ...
    { id: 'c_docs', name: 'Виктор Орлов', tag: 's4', lang: 'RU', channel: 'email', consent: true, consentAt: '06 апреля 2026', consentUntil: '06 апреля 2027', ctype: 'enduser',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_partner', name: 'Karim Aziz', tag: 's6', lang: 'EN', channel: 'whatsapp', consent: true, consentAt: '30 марта 2026', consentUntil: '30 марта 2027', ctype: 'investor',
      contactKind: 'buyer', interest: 'live', objTypes: ['apart'],
    ...
    { id: 'c_owner', name: 'Сергей Орлов', tag: 'own', lang: 'RU', channel: 'email', consent: true, consentAt: '09 мая 2026', consentUntil: '09 мая 2027', ctype: 'owner',
