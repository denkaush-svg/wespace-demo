...
(function (WS) {
  ...
  const clients = [
    {
      id: 'c_anna', name: 'Анна Петрова', nameDat: 'Анне Петровой', nameGen: 'Анны Петровой', tag: 'main', lang: 'RU', channel: 'whatsapp',
    ...
    { id: 'c_lead15', name: 'Дмитрий Соколов', nameDat: 'Дмитрию Соколову', nameGen: 'Дмитрия Соколова', tag: 's15', lang: 'RU', channel: 'telegram', consent: true, consentAt: '28 мая 2025', consentUntil: '28 мая 2026', ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_night', name: 'Sarah Mansour', nameDat: 'Sarah Mansour', nameGen: 'Sarah Mansour', tag: 's14', lang: 'EN', channel: 'whatsapp', consent: true, consentAt: '14 мая 2026', consentUntil: '14 мая 2027', ctype: 'investor',
    ...
    { id: 'c_overdue', name: 'Игорь Лебедев', nameDat: 'Игорю Лебедеву', nameGen: 'Игоря Лебедева', tag: 's5', lang: 'RU', channel: 'whatsapp', consent: true, consentAt: '02 мая 2026', consentUntil: '02 мая 2027', ctype: 'investor',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_noconsent', name: 'Марат Ибрагимов', nameDat: 'Марату Ибрагимову', nameGen: 'Марата Ибрагимова', tag: 's13', lang: 'RU', channel: 'whatsapp', consent: false, ctype: 'enduser',
    ...
    { id: 'c_ambig', name: 'Елена Крылова', nameDat: 'Елене Крыловой', nameGen: 'Елены Крыловой', tag: 'g3', lang: 'RU', channel: 'call', consent: true, consentAt: '21 февраля 2026', consentUntil: '21 февраля 2027', ctype: 'owner',
    ...
    { id: 'c_docs', name: 'Виктор Орлов', nameDat: 'Виктору Орлову', nameGen: 'Виктора Орлова', tag: 's4', lang: 'RU', channel: 'email', consent: true, consentAt: '06 апреля 2026', consentUntil: '06 апреля 2027', ctype: 'enduser',
      contactKind: 'buyer', interest: 'invest', objTypes: ['apart'],
    ...
    { id: 'c_partner', name: 'Karim Aziz', nameDat: 'Karim Aziz', nameGen: 'Karim Aziz', tag: 's6', lang: 'EN', channel: 'whatsapp', consent: true, consentAt: '30 марта 2026', consentUntil: '30 марта 2027', ctype: 'investor',
      contactKind: 'buyer', interest: 'live', objTypes: ['apart'],
    ...
    { id: 'c_owner', name: 'Сергей Орлов', nameDat: 'Сергею Орлову', nameGen: 'Сергея Орлова', tag: 'own', lang: 'RU', channel: 'email', consent: true, consentAt: '09 мая 2026', consentUntil: '09 мая 2027', ctype: 'owner',
