...
(function (WS) {
  ...
  document.addEventListener('click', (e) => {
    ...
    if (d.taskdone) { api.taskAction(d.taskdone, 'done'); return api.toast('Задача выполнена', 'ok'); }
