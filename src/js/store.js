...
(function (WS) {
  ...
  const store = {
    ...
    clientsTab: 'deals', rightPane: null, pulseTab: 'deals', pulseDay: 'today', prospIdx: 0, prospDeck: false, contactsChat: false, navRail: false, dealsView: null, navOpen: false, cgRailOpen: false, cgCtx: [], cgMenu: null, cgMode: 'auto', cgDepth: 'think',
  ...
  function resetAll() {
    ...
    store.clientsTab = 'deals'; store.pulseTab = 'deals'; store.contactsChat = false; store.navRail = false; store.pulseDay = 'today'; store.prospIdx = 0; store.prospDeck = false; store.dealsView = null; store.cgCtx = []; store.cgMenu = null; store.cgMode = 'auto'; store.cgDepth = 'think';
